/*************************************************************************
*                                                                        *
*   Module: readargv_produceTSSmaps                                      *
*                                                                        *
*   Read set up options and filenames from user input (produceTSSmaps)   *
*                                                                        *
			     ...
			     int* L)
{
  ...
  sprintf(USAGE[0],
	  ...
	  PRODUCETSSMAPS);
  sprintf(USAGE[1],
	  "NAME\n\t%s - a program to produce ChIPseq/ATACseq/RNAseq heat maps around the TSS.\n",
	  PRODUCETSSMAPS);
  sprintf(USAGE[2],
