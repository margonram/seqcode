...
int main (int argc, char *argv[])
{
  ...
  readargv_scorePhastCons(argc,argv,ChromInfoFile,RefgeneFile,PhastConsFolder,PeaksFile,TrackName,&Threshold);
  ...
  sprintf(OutputDirName,"%s_scorePhastCons",TrackName);
  ...
  /* PEAKS output file */
  sprintf(OutputFileName,"%s/scorePhastCons_%s.bed",OutputDirName,TrackName);
