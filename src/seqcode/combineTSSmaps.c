...
int main (int argc, char *argv[])
{
  ...
  sprintf(OutputDirName,"%s-%s_TSSmap_%d",TrackName1,TrackName2,L);
  ...
  /* Output files */
  sprintf(OutputFileName2,"%s/HEATmatrix_%s-%s_%d.txt",OutputDirName,TrackName1,TrackName2,L);
  sprintf(mess,"Filename for the HEAT matrix %s",OutputFileName2);
  printRes(mess);
  
  sprintf(OutputFileName3,"%s/HEATmatrix_%s-%s_%d_processed.txt",OutputDirName,TrackName1,TrackName2,L);
  sprintf(mess,"Filename for the processed HEAT matrix %s",OutputFileName3);
  printRes(mess);
  
  sprintf(OutputFileName4,"%s/HEATmatrix_%s-%s_%d_genes.txt",OutputDirName,TrackName1,TrackName2,L);
  sprintf(mess,"Filename for the HEAT gene rank %s",OutputFileName4);
  printRes(mess);
  
  sprintf(PlotFileName2,"%s/PlotHEATmap_%s-%s_%d.pdf",OutputDirName,TrackName1,TrackName2,L);
