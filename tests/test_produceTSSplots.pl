...
###################################################
#                                                 #
# Script test_produceTSSplots.pl                  #
#                                                 #
#                                                 #
...
my $TRUE = 1;
my $FALSE = 0;
my $TOOL = "produceTSSplots";
my $PROGRAM = "bin/produceTSSplots";
my $OUTPUT_FOLDER = "tests/outputs/produceTSSplots";
...
my $R2PLOTS = "tests/inputs/Rscript_produceTSSplots.txt";
...
sub check_files
{
    ...
    # 3
    $file_output = "$OUTPUT_FOLDER/test_3_TSSplot_5000/PlotTSSprofile_test_3_5000.pdf";
    ...
    # 6
    $file_output = "$OUTPUT_FOLDER/test_6_TSSplot_5000/PlotTSSprofile_test_6_5000.pdf";
    ...
    # 6 (R2plots)
    $file_output = "$OUTPUT_FOLDER/produceTSS2plots.pdf";
