...
###################################################
#                                                 #
# Script test_produceGENEmaps.pl                  #
#                                                 #
#                                                 #
...
my $TRUE = 1;
my $FALSE = 0;
my $TOOL = "produceGENEmaps";
my $PROGRAM = "bin/produceGENEmaps";
my $OUTPUT_FOLDER = "tests/outputs/produceGENEmaps";
...
my $TENGENES = "tests/inputs/10genes.txt";
my $TMP_DATE = "mydate.txt";
my $R2PLOTS = "tests/inputs/Rscript_produceGENEmaps.txt";
...
$command = "mv test_".$n_tests."_GENEmap_5000/ $OUTPUT_FOLDER/";
system("$command");
print_ok();
...
print_mess("Stage 3.  Running the test for H3K4me3 --chr10-- in mESC (one gene, default plot)\n");
...
sub check_files
{
    ...
    # 1
    $file_output = "$OUTPUT_FOLDER/test_1_GENEmap_5000/PlotHEATmap_test_1_5000.pdf";
    ...
    # 2
    $file_output = "$OUTPUT_FOLDER/test_2_GENEmap_5000/PlotHEATmap_test_2_5000.pdf";
    ...
    # 3
    $file_output = "$OUTPUT_FOLDER/test_3_GENEmap_5000/PlotHEATmap_test_3_5000.pdf";
    ...
    # 4
    $file_output = "$OUTPUT_FOLDER/test_4_GENEmap_5000/PlotHEATmap_test_4_5000.pdf";
    ...
    # 5
    $file_output = "$OUTPUT_FOLDER/test_5_GENEmap_5000/PlotHEATmap_test_5_5000.pdf";
    ...
    # 6
    $file_output = "$OUTPUT_FOLDER/test_6_GENEmap_5000/PlotHEATmap_test_6_5000.pdf";
    ...
    # 7
    $file_output = "$OUTPUT_FOLDER/test_7_GENEmap_5000/PlotHEATmap_test_7_5000.pdf";
    ...
    # 7 (R2plots)
    $file_output = "$OUTPUT_FOLDER/produceGENE2maps.pdf";
