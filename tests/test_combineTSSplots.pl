...
print_mess("Stage 1.  Running the test for H3K4me3 --chr10-- in mESC (default TSS plot)\n");
...
print_mess("Stage 2.  Running the test for H3 --chr10-- in mESC (default TSS plot)\n");
...
print_mess("Stage 3.  Running the test for H3K4me3/H3 --chr10-- in mESC (default TSS plot)\n");
...
print_mess("Stage 4.  Running the test for H3K4me3 --chr10-- in mESC (default TSS plot, one gene)\n");
...
print_mess("Stage 5.  Running the test for H3 --chr10-- in mESC (default TSS plot, one gene)\n");
...
print_mess("Stage 6.  Running the test for H3K4me3/H3 --chr10-- in mESC (default TSS plot, one gene)\n");
