...
###################################################
#                                                 #
# Script test_produceGENEplots.pl                 #
#                                                 #
#                                                 #
...
my $TRUE = 1;
my $FALSE = 0;
my $TOOL = "produceGENEplots";
my $PROGRAM = "bin/produceGENEplots";
my $OUTPUT_FOLDER = "tests/outputs/produceGENEplots";
my $GENOME = "tests/inputs/ChromInfo.txt";
my $REFGENE = "tests/inputs/refGene.txt";
my $READS = "tests/inputs/H3K4me3_chr10.bam";
my $READS2 = "tests/inputs/H3_chr10.bam";
my $GENES = "tests/inputs/genes_chr10.txt";
my $ONEGENE = "tests/inputs/onegene.txt";
my $TMP_DATE = "mydate.txt";
my $R2PLOTS = "tests/inputs/Rscript_produceGENEplots.txt";
...
$command = "mv test_".$n_tests."_GENEplot_5000/ $OUTPUT_FOLDER/";
system("$command");
print_ok();
...
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -w 100 $GENOME $REFGENE $READS $GENES $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_GENEplot_5000/ $OUTPUT_FOLDER/";
...
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -u $GENOME $REFGENE $READS $GENES $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_GENEplot_5000/ $OUTPUT_FOLDER/";
...
## Step 4. One gene (default plot)


print_mess("Stage 4.  Running the test for H3K4me3 --chr10-- in mESC (one gene, default plot)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose $GENOME $REFGENE $READS $ONEGENE $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_GENEplot_5000/ $OUTPUT_FOLDER/";
...
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -b black -B black -f darkgoldenrod1 -F darkgoldenrod1 $GENOME $REFGENE $READS $GENES $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_GENEplot_5000/ $OUTPUT_FOLDER/";
...
sub check_files
{
    ...
    # 1
    $file_output = "$OUTPUT_FOLDER/test_1_GENEplot_5000/PlotGENEprofile_test_1_5000.pdf";
    ...
    # 2
    $file_output = "$OUTPUT_FOLDER/test_2_GENEplot_5000/PlotGENEprofile_test_2_5000.pdf";
    ...
    # 3
    $file_output = "$OUTPUT_FOLDER/test_3_GENEplot_5000/PlotGENEprofile_test_3_5000.pdf";
    ...
    # 4
    $file_output = "$OUTPUT_FOLDER/test_4_GENEplot_5000/PlotGENEprofile_test_4_5000.pdf";
    ...
    # 5
    $file_output = "$OUTPUT_FOLDER/test_5_GENEplot_5000/PlotGENEprofile_test_5_5000.pdf";
    ...
    # 6
    $file_output = "$OUTPUT_FOLDER/test_6_GENEplot_5000/PlotGENEprofile_test_6_5000.pdf";
    ...
    # 6 (R2plots)
    $file_output = "$OUTPUT_FOLDER/produceGENE2plots.pdf";
