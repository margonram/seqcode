...
print_mess("Stage 2.  Running the test for H3 --chr10-- in mESC (default profile)\n");
...
print_mess("Stage 3.  Running the test for H3K4me/H3 --chr10-- in mESC (default profile)\n");
...
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."-test_".$n_tests."_BedGraph_profile/ $OUTPUT_FOLDER/";
system("$command");
print_ok();
...
sub check_files
{
    ...
    # 3
    $file_output = "$OUTPUT_FOLDER/test_3-test_3_BedGraph_profile/test_3-test_3.bedgraph.gz";
