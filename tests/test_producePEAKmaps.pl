...
###################################################
#                                                 #
# Script test_producePEAKmaps.pl                  #
#                                                 #
#                                                 #
...
my $TRUE = 1;
my $FALSE = 0;
my $TOOL = "producePEAKmaps";
my $PROGRAM = "bin/producePEAKmaps";
my $OUTPUT_FOLDER = "tests/outputs/producePEAKmaps";
my $GENOME = "tests/inputs/ChromInfo.txt";
my $READS = "tests/inputs/H3K4me3_chr10.bam";
my $READS2 = "tests/inputs/H3_chr10.bam";
my $PEAKS = "tests/inputs/H3K4me3_chr10.bed";
my $ONEPEAK = "tests/inputs/onepeak.bed";
my $TMP_DATE = "mydate.txt";
my $R2PLOTS = "tests/inputs/Rscript_producePEAKmaps.txt";
...
print_mess("Stage 1.  Running the test for H3K4me3 --chr10-- in mESC (default plot)\n");

# building the command
$n_tests = 1;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose $GENOME $READS $PEAKS $name 5000";
print_mess("$command");
system("$command");
...
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
system("$command");
print_ok();
...
print_mess("Stage 2.  Running the test for H3K4me3 --chr10-- in mESC (lower resolution)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -w 1000 $GENOME $READS $PEAKS $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
...
## Step 3. One peak (default plot)


print_mess("Stage 3.  Running the test for H3K4me3 --chr10-- in mESC (one peak, default plot)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose $GENOME $READS $ONEPEAK $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
...
print_mess("Stage 4.  Running the test for H3K4me3 --chr10-- in mESC (another color scheme)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -b black -B black -H black -f darkgoldenrod1 -F darkgoldenrod1 $GENOME $READS $PEAKS $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
...
print_mess("Stage 5.  Running the test for H3K4me3 --chr10-- in mESC (noise reduction plot)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -t 0 $GENOME $READS $PEAKS $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
...
print_mess("Stage 6.  Running the test for H3K4me3 --chr10-- in mESC (noise reduction plot 2)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose -t 2 $GENOME $READS $PEAKS $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
...
print_mess("Stage 7.  Running the test for H3 --chr10-- in mESC (default plot)\n");

# building the command
$n_tests++;
$name = "test_".$n_tests;
$command = "$PROGRAM $verbose $GENOME $READS2 $PEAKS $name 5000";
print_mess("$command");
system("$command");
# move the results to outputs
$command = "mv test_".$n_tests."_PEAKmap_5000/ $OUTPUT_FOLDER/";
...
## Step 8. Finishing successful program execution
my $stop;


print_mess("Stage 8.  Finishing the test ($TOOL)\n");
...
sub check_files
{
    ...
    # 1
    $file_output = "$OUTPUT_FOLDER/test_1_PEAKmap_5000/PlotHEATmap_test_1_5000.pdf";
    ...
    # 2
    $file_output = "$OUTPUT_FOLDER/test_2_PEAKmap_5000/PlotHEATmap_test_2_5000.pdf";
    ...
    # 3
    $file_output = "$OUTPUT_FOLDER/test_3_PEAKmap_5000/PlotHEATmap_test_3_5000.pdf";
    ...
    # 4
    $file_output = "$OUTPUT_FOLDER/test_4_PEAKmap_5000/PlotHEATmap_test_4_5000.pdf";
    ...
    # 5
    $file_output = "$OUTPUT_FOLDER/test_5_PEAKmap_5000/PlotHEATmap_test_5_5000.pdf";
    ...
    # 6
    $file_output = "$OUTPUT_FOLDER/test_6_PEAKmap_5000/PlotHEATmap_test_6_5000.pdf";
    ...
    # 7
    $file_output = "$OUTPUT_FOLDER/test_7_PEAKmap_5000/PlotHEATmap_test_7_5000.pdf";
    ...
    # 7 (R2plots)
    $file_output = "$OUTPUT_FOLDER/producePEAK2maps.pdf";
